...
<script>
  import {fetchList,updateRecommendStatus,deleteHotBook,createHotBook,updateHotBookSort} from '@/api/hotBook';
    ...
    methods: {
      ...
      handleSelectDialogConfirm(){
        ...
        this.$confirm('使用要进行添加操作?', '提示', {
          ...
          createHotBook(selectBooks).then(response=>{
      ...
      handleUpdateSort(){
        this.$confirm('是否要修改排序?', '提示', {
          ...
          updateHotBookSort(this.sortDialogData).then(response=>{
      ...
      deleteBook(ids){
        this.$confirm('是否要删除该推荐?', '提示', {
          ...
          let params=new URLSearchParams();
          params.append("ids",ids);
          deleteHotBook(params).then(response=>{
            this.getList();
            this.$message({
              type: 'success',
              message: '删除成功!'
